...
/***/ "./resources/js/files/bts_js/bootstrap.bundle.min.js":
/*!***********************************************************!*\
  !*** ./resources/js/files/bts_js/bootstrap.bundle.min.js ***!
  \***********************************************************/
...
/***/ "./resources/js/files/hero_js/custom.js":
/*!**********************************************!*\
  !*** ./resources/js/files/hero_js/custom.js ***!
  \**********************************************/
/***/ (() => {
...
var subMenuItem = document.querySelectorAll("ul li.has-sub-ui");
subMenuItem.forEach(function (el) {
  return el.addEventListener("click", function () {
    var vh = el.children[1].scrollHeight;

    if (el.classList.contains("open")) {
      el.classList.remove("open"); // el.children[1].classList.remove('open');

      el.children[1].style.height = 0;
    } else {
      subMenuItem.forEach(function (el2) {
        return el2.children[1].style.height = 0, el2.classList.remove("open");
      });
      el.classList.add("open"); // el.children[1].classList.add('open');
...
onload = get_code; //کپی تو کلیپبرد
...
__webpack_require__(/*! ../files/bts_js/bootstrap.bundle.min */ "./resources/js/files/bts_js/bootstrap.bundle.min.js");

__webpack_require__(/*! ../files/hero_js/custom */ "./resources/js/files/hero_js/custom.js");


window.Swal = (sweetalert2__WEBPACK_IMPORTED_MODULE_0___default());

__webpack_require__(/*! persianjs */ "./node_modules/persianjs/persian.js");
...
/******/ 	__webpack_require__.O(undefined, ["css/user/app","css/admin/app"], () => (__webpack_require__("./resources/js/user/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/user/app","css/admin/app"], () => (__webpack_require__("./resources/scss/user/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/user/app","css/admin/app"], () => (__webpack_require__("./resources/scss/admin/app.scss")))
